...
class BillsToIncome extends Component {
  constructor(props) {
    super(props)
    this.state = {
    }
...
export default connect(mapStateToProps, { getBills, createBill, updateBill, getMonthlyBillTotal, deleteBill, getIncome, createIncome, updateIncome, getMonthlyIncomeTotals, deleteIncome })(BillsToIncome)